            ...
            chrome.tabs.query({windowId: chrome.windows.WINDOW_ID_CURRENT, active: true}, function(tabs) {
                ...
                chrome.tabs.executeScript(tabs[0].id,{code:`setInterval(function() {
                    if(1 >= window.outerHeight - window.innerHeight) {
                        ...
                        document.querySelectorAll('.html5-main-video')[0].style.left = "400px";
                        document.querySelectorAll('.html5-main-video')[0].style.width = "100vh";
                    } else {
                        document.querySelectorAll('.html5-video-player')[0].style.top = "300px";
                        document.querySelectorAll('.html5-video-player')[0].style.left = "-200px";
                        document.querySelectorAll('.html5-main-video')[0].style.width = "calc(100vh - 80px)";
                    }
                }, 100)`});
            });
        });
